...
This device can be used to alert other people in your building that you are in an online meeting or video/sound recording session, to avoid disturbance. When the light is active, you can control it from a webpage with buttons. The webpage also displays the battery voltage. 
